...
if len(black_coordinates) > 1:
    ...
    # Check for slant lines
    is_slant_line_positive = all(y - y_coordinates[0] == x - x_coordinates[0] for x, y in black_coordinates)
    is_slant_line_negative = all(y - y_coordinates[0] == -(x - x_coordinates[0]) for x, y in black_coordinates)
    is_slant_line = is_slant_line_positive
    is_rev_slant = is_slant_line_negative
else:
...
if is_horizontal_line and is_vertical_line and is_slant_line:
    ...
    print("The input image represents a reverse slant line.")
else:
